...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ 𝗢𝗡 ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ 𝗢𝗡 ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ 𝗢𝗡 ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua OKEEN.lua')
end
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./OKEEN.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("KN", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S OKEEN -X kill
screen -S OKEEN ./OKEEN
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SRC-DRAGON/Files_OKEEN/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,872013743,872013743}   
...
function DevAnas(msg) 
local hash = database:sismember(bot_id.."Dev:Anas:2", msg.sender_user_id_) 
...
if hash or SudoBot(msg) or DevAnas(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevAnas(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevAnas(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevAnas(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevAnas(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."l3lll3l:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or SudoBot(msg) or DevAnas(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
...
if hash or SudoBot(msg) or DevAnas(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevAnas(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
var = true  
elseif tonumber(user_id) == tonumber(872013743) then
var = true  
elseif tonumber(user_id) == tonumber(872013743) then
var = true  
...
var = true  
elseif database:sismember(bot_id.."Dev:Anas:2", user_id) then
var = true  
...
var = true  
elseif database:sismember(bot_id..'l3lll3l:MN:TF'..chat_id, user_id) then
var = true 
...
local OKEEN_Msg = ''  
if msgs < 100 then 
OKEEN_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
OKEEN_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
OKEEN_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
OKEEN_Msg = 'متفاعل' 
elseif msgs < 1200 then 
OKEEN_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
OKEEN_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
OKEEN_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
OKEEN_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
OKEEN_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
OKEEN_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
OKEEN_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
OKEEN_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
OKEEN_Msg = 'رب التفاعل'  
end 
return OKEEN_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝗢𝗞𝗘𝗘𝗡 𝗖𝗛𝗔𝗡𝗡𝗘𝗟.")  
...
function plugin_OKEEN(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.OKEEN and msg then
pre_msg = plugin.OKEEN(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceOKEEN(msg,data) -- بداية العمل
if msg then
...
if DevAnas(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,OKEEN_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ✯︎' and DevAnas(msg) then  
...
if text == 'تعطيل التواصل ✯︎' and DevAnas(msg) then  
...
if text == 'تفعيل البوت الخدمي ✯︎' and DevAnas(msg) then  
...
if text == 'تعطيل البوت الخدمي ✯︎' and DevAnas(msg) then  
...
if text == 'ضع كليشه ستارت ✯︎' and DevAnas(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ✯︎¦ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ✯︎' and DevAnas(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ✯︎¦ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ✯︎' and DevAnas(msg) then 
...
if text == 'تحديث السورس ✯︎' and DevAnas(msg) then 
os.execute('rm -rf OKEEN.lua')
os.execute('wget https://raw.githubusercontent.com/SRC-DRAGON/OKEEN/main/OKEEN.lua')
send(msg.chat_id_, msg.id_,' ✯︎¦ تم تحديث السورس \n ✯︎¦ لديك اخر اصدار لسورس اوكين\n ✯︎¦ الاصدار » { v 1.5}')
dofile('OKEEN.lua')  
end
if text == 'الاصدار ✯︎' and DevAnas(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✯︎¦ اصدار سورس اوكين \n ✯︎¦ الاصدار »{ v 1.5}')
end
if text == "ضع اسم للبوت ✯︎" and DevAnas(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ✯︎¦ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ✯︎' and DevAnas(msg) then 
...
if text == 'المشتركين ✯︎' and DevAnas(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ✯︎¦ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ✯︎' and DevAnas(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ✯︎¦ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✯︎") and DevAnas(msg) then
...
if text == ("قائمه العام ✯︎") and DevAnas(msg) then
...
if text == ("قائمه الكتم العام ✯︎") and DevAnas(msg) then
...
if text=="اذاعه خاص ✯︎" and msg.reply_to_message_id_ == 0 and DevAnas(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✯︎¦ ارسل الان اذاعتك؟ \n ✯︎¦ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ✯︎" and msg.reply_to_message_id_ == 0 and DevAnas(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✯︎¦ ارسل الان اذاعتك؟ \n ✯︎¦ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ✯︎" and msg.reply_to_message_id_ == 0 and DevAnas(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✯︎¦ ارسل الان اذاعتك؟ \n ✯︎¦ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ✯︎" and msg.reply_to_message_id_ == 0  and DevAnas(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✯︎¦ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ✯︎" and msg.reply_to_message_id_ == 0  and DevAnas(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✯︎¦ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✯︎' and DevAnas(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✯︎" and DevAnas(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ✯︎" and DevAnas(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'✯︎¦  عدد الكروبات الان » { '..#group..' }'..OKEENk..''..OKEEN..'\n✯︎¦  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevAnas(msg) then
...
usertext = '\n ✯︎¦ العضو » ['..result.title_..'](t.me/'..(username or 'ccscc2')..')'
status  = '\n ✯︎¦ تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevAnas(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevAnas(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevAnas(msg) then
...
local OKEEN1_Msg = database:get(bot_id.."OKEEN1:Add:Filter:Rp2"..text..msg.chat_id_)   
if OKEEN1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✯︎¦ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ccscc2')..') \n ✯︎¦ '..OKEEN1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if OKEEN_Msg and not Special(msg) then  
local OKEEN_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if OKEEN_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✯︎¦ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ✯︎¦ ["..OKEEN_Msg.."] \n")
else
send(msg.chat_id_,0," ✯︎¦ العضو : {["..data.first_name_.."](T.ME/ccscc2)}\n ✯︎¦ ["..OKEEN_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✯︎¦ عذرا » {["..data.first_name_.."](T.ME/ccscc2)}\n ✯︎¦ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevAnas(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevAnas(msg) then
...
if text == 'تحديث السورس' and DevAnas(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تغير الاشتراك$") and DevAnas(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ✯︎¦ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevAnas(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ✯︎¦ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ✯︎" and DevAnas(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ✯︎¦ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✯︎$") and DevAnas(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ✯︎¦ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✯︎" and DevAnas(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ✯︎" and DevAnas(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ✯︎¦ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ✯︎" and DevAnas(msg) then  
...
database:sadd(bot_id.."OKEEN:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."OKEEN:blocname"..msg.chat_id_)
...
function l3lll3l_name(t1,t2)
if t2.id_ then 
name_MRAnas = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_MRAnas then 
names_MRAnas = database:smembers(bot_id.."OKEEN:blocname"..msg.chat_id_) or ""
if names_MRAnas and names_MRAnas[1] then 
for i=1,#names_MRAnas do 
if name_MRAnas:match("(.*)("..names_MRAnas[i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_, l3lll3l_name)
end
...
database:set(bot_id.."OKEEN:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."OKEEN:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."OKEEN:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."OKEEN:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."OKEEN:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function Anas_mrAnas_new(mrAnas1,mrAnas2)
if mrAnas2 and mrAnas2.first_name_ then 
if mrAnas2.first_name_:match("(.*)"..database:get(bot_id.."OKEEN:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."OKEEN:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrAnas_nnn = database:get(bot_id.."OKEEN:nump"..msg.chat_id_) or 5
local mrAnas_nnn2 = database:get(bot_id.."OKEEN:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrAnas_nnn2) == tonumber(mrAnas_nnn) or tonumber(mrAnas_nnn2) > tonumber(mrAnas_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."OKEEN:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✯︎¦ عزيزي >>["..mrAnas2.username_.."](https://t.me/"..(mrAnas2.username_ or "ccscc2")..")\n✯︎¦ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."OKEEN:teh"..msg.chat_id_).."} بجانب اسمك\n✯︎¦ عدد المحاولات المتبقيه {"..(tonumber(mrAnas_nnn) - tonumber(mrAnas_nnn2)).."}")
end
end
end
end
bnnaGet(id, Anas_mrAnas_new)
end
end
...
database:set(bot_id.."Ttn:KN:stats"..msg.chat_id_,"open")
end
...
database:set(bot_id.."Ttn:KN:stats"..msg.chat_id_,"close")
end
if text and database:get(bot_id.."Ttn:KN:stats"..msg.chat_id_) == "open" then 
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)
if data.id_ then 
if data.id_ ~= bot_id then
local OKEENChengName = database:get(bot_id.."OKEEN:Cheng:Name"..data.id_)
if not data.first_name_ then 
if OKEENChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..OKEENChengName..']')
database:del(bot_id.."OKEEN:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if OKEENChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."OKEEN:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local OKEENChengUserName = database:get(bot_id.."OKEEN:Cheng:UserName"..data.id_)
if not data.username_ then 
if OKEENChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..OKEENChengUserName..']')
database:del(bot_id.."OKEEN:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if OKEENChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."OKEEN:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local OKEENChengPhoto = database:get(bot_id.."OKEEN:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if OKEENChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."OKEEN:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if OKEENChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."OKEEN:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
[✯︎¦sᴏᴜʀᴄᴇ ғɪʟᴇs ♡](https://t.me/OK_EEN)
≪━━━━━━━━━━━━━≫
...
if text == 'رفع نسخه الاحتياطيه' and DevAnas(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'جلب نسخه الاحتياطيه' and DevAnas(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✯︎¦ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ccscc2')..') \n ✯︎¦ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✯︎¦ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ccscc2')..') \n ✯︎¦ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevAnas(msg) then    
dofile('OKEEN.lua')  
send(msg.chat_id_, msg.id_, ' ✯︎¦ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevAnas(msg) then
database:del(bot_id..'GBan:User')
send(msg.chat_id_, msg.id_, '\n ✯︎¦ تم مسح قائمه العام')
return false
end
if text == ("قائمه العام") and DevAnas(msg) then
local list = database:smembers(bot_id..'GBan:User')
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevAnas(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevAnas(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevAnas(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevAnas(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevAnas(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevAnas(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevAnas(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevAnas(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevAnas(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevAnas(msg) then
database:del(bot_id..'Sudo:User')
send(msg.chat_id_, msg.id_, "\n ✯︎¦ تم مسح قائمة المطورين  ")
end
if text == ("المطورين") and DevAnas(msg) then
local list = database:smembers(bot_id..'Sudo:User')
...
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
if database:get(bot_id.."l3lll3l:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'l3lll3l:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(argg,dataa) 
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = dataa.member_count_},function(ta,Anas)
x = 0
tags = 0
local list = Anas.members_
for k, v in pairs(list) do
...
if text == 'الملفات' and DevAnas(msg) then
t = ' ✯︎¦ ملفات السورس اوكين ↓\n ٴ≪┉ ┉ ┉ ┉ ┉ 𝗢𝗡 ┉  ┉ ┉ ┉ ┉≫ٴ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevAnas(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SRC-DRAGON/Files_OKEEN/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ✯︎¦ اهلا بك في متجر ملفات اوكين\n ✯︎¦ ملفات السورس ↓\nٴ≪┉ ┉ ┉ ┉ ┉ 𝗢𝗡 ┉  ┉ ┉ ┉ ┉≫ٴ\n\n"
local TextE = "\nٴ≪┉ ┉ ┉ ┉ ┉ 𝗢𝗡 ┉  ┉ ┉ ┉ ┉≫ٴ\n ✯︎¦ علامة تعني { ✔️ } ملف مفعل\n ✯︎¦ علامة تعني { ✖ } ملف معطل\n ✯︎¦ قناة سورس اوكين ↓\n".." ✯︎¦ [اضغط هنا لدخول](t.me/ccscc2) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevAnas(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/SRC-DRAGON/Files_OKEEN/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('OKEEN.lua')  
else
send(msg.chat_id_, msg.id_," ✯︎¦ عذرا الملف لايدعم سورس اوكين \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevAnas(msg) then
...
if text == "مسح الملفات" and DevAnas(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ✯︎¦ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevAnas(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevAnas(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if database:get(bot_id..'DRAGOON:change:Anas'..msg.chat_id_) then
Text = 'تم تفعيل تحويل الصيغ'
database:del(bot_id..'DRAGOON:change:Anas'..msg.chat_id_)  
else
...
if not database:get(bot_id..'DRAGOON:change:Anas'..msg.chat_id_) then
database:set(bot_id..'DRAGOON:change:Anas'..msg.chat_id_,true)  
...
if text == 'تحويل' and not database:get(bot_id..'DRAGOON:change:Anas'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
function Function_OKEEN(extra, result, success)
database:sadd(bot_id.."Dev:Anas:2", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","✯︎¦ تم ترقيته مطور ثانوي في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_OKEEN, nil)
return false 
end
...
function Function_OKEEN(extra, result, success)
database:srem(bot_id.."Dev:Anas:2", result.sender_user_id_)
...
function Function_OKEEN(extra, result, success)
if result.id_ then
database:srem(bot_id.."Dev:Anas:2", result.id_)
...
database:del(bot_id.."Dev:Anas:2")
...
database:del(bot_id..'l3lll3l:MN:TF'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ✯︎¦ تم مسح المنظفين')
end
if text == ("المنظفين") and BasicConstructor(msg) then
local list = database:smembers(bot_id..'l3lll3l:MN:TF'..msg.chat_id_)
t = "\n ✯︎¦ قائمة المنظفين \n≪━━━━━━𝓓𝓡𝓖━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'l3lll3l:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✯︎¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ccscc2')..')'
status  = '\n ✯︎¦ تم ترقيته منظف'
send(msg.chat_id_, msg.id_, usertext..status)
...
database:sadd(bot_id..'l3lll3l:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ✯︎¦ العضو » ['..result.title_..'](t.me/'..(username or 'ccscc2')..')'
status  = '\n ✯︎¦ تم ترقيته منظف'
texts = usertext..status
else
...
database:sadd(bot_id..'l3lll3l:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✯︎¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ccscc2')..')'
status  = '\n ✯︎¦ تم ترقيته منظف'
...
function start_function(extra, result, success)
database:srem(bot_id..'l3lll3l:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✯︎¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ccscc2')..')'
...
function start_function(extra, result, success)
if result.id_ then
database:srem(bot_id..'l3lll3l:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ✯︎¦ العضو » ['..result.title_..'](t.me/'..(username or 'ccscc2')..')'
status  = '\n ✯︎¦ تم تنزيله من المنظفين'
texts = usertext..status
else
...
database:srem(bot_id..'l3lll3l:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✯︎¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ccscc2')..')'
status  = '\n ✯︎¦ تم تنزيله من المنظفين'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✯︎¦ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ccscc2')..')'
status  = '\n ✯︎¦ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✯︎¦ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✯︎¦ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ccscc2')..')'
...
if link then                              
send(msg.chat_id_,msg.id_,'🌐┇ 𝙻𝙸𝙽𝙺 ɢʀᴏᴜᴘ.\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n ['..ta.title_..']('..link..')')                          
else                
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if linkgpp.ok == true then 
...
database:set(bot_id.."OKEEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."OKEEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ✯︎¦ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."OKEEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."OKEEN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."OKEEN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."OKEEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ✯︎¦ تم منع الكلمه مع التحذير")  
database:del(bot_id.."OKEEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."OKEEN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."OKEEN1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."OKEEN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ✯︎¦ ارسل الكلمه الان")  
database:set(bot_id.."OKEEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."OKEEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."OKEEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."OKEEN1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."OKEEN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."OKEEN1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."OKEEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."OKEEN1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."OKEEN1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ✯︎¦ قائمة المنع \nٴ≪┉ ┉ ┉ ┉ ┉ 𝗢𝗡 ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do  
local OKEEN_Msg = database:get(bot_id.."OKEEN1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..OKEEN_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevAnas(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ✯︎¦ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevAnas(msg) then
...
if text == 'تفعيل الاذاعه' and DevAnas(msg) then  
...
if text == 'تعطيل الاذاعه' and DevAnas(msg) then  
...
if text == 'تفعيل التواصل' and DevAnas(msg) then  
if database:get(bot_id..'Tuasl:Bots') then
database:del(bot_id..'Tuasl:Bots') 
Text = '\n ✯︎¦ تم تفعيل التواصل' 
else
...
if text == 'تعطيل التواصل' and DevAnas(msg) then  
if not database:get(bot_id..'Tuasl:Bots') then
database:set(bot_id..'Tuasl:Bots',true) 
Text = '\n ✯︎¦ تم تعطيل التواصل' 
else
...
if text == 'تفعيل البوت الخدمي' and DevAnas(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تعطيل البوت الخدمي' and DevAnas(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if not database:get(bot_id..'l3lll3l:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'l3lll3l:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
database:sadd(bot_id.."l3lll3l:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."l3lll3l:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "✯︎¦ تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."l3lll3l:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."l3lll3l:allM"..msg.chat_id_)
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'اوكين').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'اوكين')
local OKEEN_Msg = {
'عمغي 🥺💕.',
...
send(msg.chat_id_, msg.id_,'['..OKEEN_Msg[math.random(#OKEEN_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevAnas(msg) then 
...
if database:sismember(bot_id..'l3lll3l:MN:TF'..msg.chat_id_, result.id_) then
mn = 'منظف ،' else mn = '' end
...
own = 'مدير ،' else own = '' end
if database:sismember(bot_id..'l3lll3l:MN:TF'..msg.chat_id_, result.sender_user_id_) then
mn = 'منظف ،' else mn = '' end
...
database:srem(bot_id..'l3lll3l:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id..'Dev:Anas:2',msg.sender_user_id_) then
database:srem(bot_id..'l3lll3l:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevAnas(msg) then 
...
if text == ("ردود المطور") and DevAnas(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ✯︎¦ قائمة ردود المطور \nٴ≪┉ ┉ ┉ ┉ ┉ 𝗢𝗡 ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevAnas(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevAnas(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:OKEEN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ✯︎¦ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:OKEEN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:OKEEN:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:OKEEN:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:OKEEN:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"✯︎¦ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:OKEEN:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:OKEEN:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:OKEEN:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:OKEEN:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:OKEEN:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:OKEEN:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:OKEEN:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:OKEEN:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:OKEEN:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:OKEEN:List:Rd:Sudo")
end
...
database:set(bot_id.."ccscc2:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."ccscc2:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."ccscc2:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."ccscc2:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"✯︎¦ تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."ccscc2:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."ccscc2:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس اوكين يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:OKEEN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:OKEEN:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"✯︎¦ ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:OKEEN:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:OKEEN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:OKEEN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:OKEEN:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:OKEEN:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:OKEEN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:OKEEN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:OKEEN:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:OKEEN:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:OKEEN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:OKEEN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:OKEEN:Add:Rd:Sudo:Text2"..test, text)  
end  
send(msg.chat_id_, msg.id_,"✯︎¦ تم حفظ الرد")
return false  
end  
...
if text then
local Text = database:get(bot_id.."botss:OKEEN:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:OKEEN:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:OKEEN:Add:Rd:Sudo:Text2"..text)   
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'اوكين').." غادر" or text == 'بوت غادر' then  
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'اوكين')
send(msg.chat_id_, msg.id_,'آسـمـي آللـطـيف ['..Namebot..'] ')
end
...
if text == 'تفعيل المغادره' and DevAnas(msg) then   
...
if text == 'تعطيل المغادره' and DevAnas(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'ccscc2')..')'
local iduser = result.sender_user_id_
...
local Anas = ' ✯︎¦ عدد الادمنيه : '..data.administrator_count_..
...
send(msg.chat_id_, msg.id_, Anas) 
end,nil)
end,nil)
end 
...
if not database:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
database:sadd(bot_id..'Spam:Texting'..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da)  tdcli_function ({ ID = "SendChatAction",  chat_id_ = msg.sender_user_id_, action_ = {  ID = "SendMessageTypingAction", progress_ = 100}  },function(arg,ta)  tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)  tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,Anas,success) 
if da.status_.ID == "ChatMemberStatusCreator" then 
rtpa = 'المالك'
elseif da.status_.ID == "ChatMemberStatusEditor" then 
rtpa = 'مشرف' 
...
local photps = (Anas.total_count_ or 0)
...
local rdphoto = Anasa[math.random(#Anasa)]
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_) then      
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, Anas.photos_[0].sizes_[1].photo_.persistent_id_,get_id_text)       
else 
...
if text == "تنظيف المشتركين" and DevAnas(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات" and DevAnas(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Anas = text:match("^اضف رسائل (%d+)$")
database:set(bot_id..'id:user'..msg.chat_id_,Anas)  
...
Anas = text:match("^اضف نقاط (%d+)$")
database:set(bot_id..'idgem:user'..msg.chat_id_,Anas)  
...
if text == 'استعاده الاوامر' and DevAnas(msg) then
...
{
{text = '𝗢𝗞𝗘𝗘𝗡 𝗖𝗛𝗔𝗡𝗡𝗘𝗟', url="t.me/ccscc2"},
},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard.inline_keyboard = {
{
{text = 'كتم الاسماء', callback_data="/mute-name"},{text = 'التوحيد', callback_data="/Anas"},{text = 'تنبيه الأسماء', callback_data="/change-names"},
},
{
...
database:set(bot_id.." Anas:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزغرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'✯︎¦ تم تفعيل الزغرفه')
database:set(bot_id.." Anas:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زغرفه (.*)$") and database:get(bot_id.." Anas:zhrf_Bots"..msg.chat_id_) == "open" then
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ 𝗢𝗡 ┉  ┉ ┉ ┉ ┉≫ٴٴ\n✯︎¦ ➫ .[🖨┇𝗢𝗞𝗘𝗘𝗡 𝗖𝗛𝗔𝗡𝗡𝗘𝗟. ](t.me/OK_EEN)➤ ')
end
if text == "تعطيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_, '✯︎¦ تم تعطيل الابراج')
database:set(bot_id.." Anas:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'✯︎¦ تم تفعيل الابراج')
database:set(bot_id.." Anas:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.." Anas:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.." Anas:age_Bots"..msg.chat_id_,"close")
end
if text == "تعطيل حساب العمر" and Manager(msg) then
send(msg.chat_id_, msg.id_, '✯︎¦ تم تعطيل حساب العمر')
database:set(bot_id.." Anas:age_Bots"..msg.chat_id_,"close")
...
database:set(bot_id.." Anas:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.." Anas:age_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."Anas:movie_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الافلام" and Mod(msg) then
send(msg.chat_id_, msg.id_,'✯︎¦ تم تفعيل الافلام')
database:set(bot_id.."Anas:movie_bot"..msg.chat_id_,"open")
end
if text and text:match("^فلم (.*)$") and database:get(bot_id.."Anas:movie_bot"..msg.chat_id_) == "open" then
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'اوكين')
...
OKEEN = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(OKEEN)
...
--------------------------------------------------------------------------------------------------------------
SourceOKEEN(data.message_,data)
plugin_OKEEN(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local OKEENAbot = database:get(bot_id.."OKEEN1:Add:Filter:Rp2"..text..result.chat_id_)   
if OKEENAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✯︎¦ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ✯︎¦ ["..OKEENAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local OKEEN1_Msg = database:get(bot_id.."OKEEN1:Add:Filter:Rp2"..text..result.chat_id_)   
if OKEEN1_Msg then    
send(msg.chat_id_, msg.id_," ✯︎¦ "..OKEEN1_Msg)
...
end -- end new msg dev.mr Anas 
end -- end callback dev.mr Anas
